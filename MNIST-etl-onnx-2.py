...
# Load onnx
onnx_model_path = 'output_onnx/mnist_seed0_batch_size32_learning_rate5e-05_epoch7_2.onnx'
...
torch.onnx.export(
    ...
    'output_onnx/mnist_seed0_batch_size32_learning_rate5e-05_epoch7_3.onnx',  # Output ONNX file
...
show(p)
'''
os.system('python MNIST-etl-onnx-3.py')