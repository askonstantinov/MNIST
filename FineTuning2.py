...
onnx_model_path = 'output_onnx/FineTuned1.onnx'
...
torch.onnx.export(
    ...
    'output_onnx/FineTuned2.onnx',  # Расположение и наименование итогового файла onnx
    input_names=['input'],
    output_names=['output'],
...
os.system('python FineTuning3.py')
